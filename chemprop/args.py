...
class TrainArgs(CommonArgs):
    ...
    def process_args(self) -> None:
        ...
        for (features_argument, base_features_path, val_features_path, test_features_path) in [
            (
                    '`--features_path`', self.features_path, self.separate_val_features_path,
...
class ActiveLearningArgs(TrainArgs):
    ...
    data_selection_criterion: Literal['random', 'mve_var', 'mve_var_scaled', 'ens_var', 'ens_var_scaled', 'cluster_equal', 'cluster_weight', 'on_the_fly_clustering', 'on_the_fly_clustering_silhouette', 'on_the_fly_clustering_in_cluster_dist_ratio', 'on_the_fly_clustering_weight', 'error_calibration_cluster', 'error_calibration_learning']
    ...
    """on_the_fly_clustering_weight: based on on-the-fly clustering of latent representation with weighted distribution based on cluster ensemble variance"""
    ...
    calibration_error_type: Literal['absolute', 'bias'] = 'absolute'
